...
curl --header "Content-Type: application/json" \
  --header "Authorization: Bearer $TOKEN" \
  --request POST \
  --data '{"personName": "Tomas Maria", "birthDate": "1996-07-18", "vat": "231873417", "houseNumber": "12", "street": "Rua Direita", "city": "Sandim", "country": "Portugal", "zipCode": "1234-234", "email": "'"$ADMIN_ID1"'", "familyName": "Constantino", "phoneNumbers": ["912345612", "915768456"], "description": "The Constantino family", "username": "Tomas", "password": "1234"}' \
  $URL_HTTP/families > temp.temp

echo "MEMBERS FAMILY 1 -------------------------------------"
