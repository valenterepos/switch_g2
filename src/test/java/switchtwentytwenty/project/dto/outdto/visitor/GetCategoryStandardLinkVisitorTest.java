...
public class GetCategoryStandardLinkVisitorTest {
    ...
    void getSelfLink() throws ElementNotFoundException {
        ...
        //arrange
        IAddLinkVisitor visitor = new GetCategoryStandardLinkVisitor();
    ...
    void getSelfLinkNullInput() {
        ...
        //act and assert
        Assertions.assertDoesNotThrow(() -> visitor.visit(dto));
    }
}
