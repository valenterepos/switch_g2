...
public class CreateOrUpdateFamilyRelationController implements ICreateOrUpdateFamilyRelationController {
    ...
    public ResponseEntity<Object> createOrUpdateFamilyRelation(@PathVariable(value = "familyID") String familyIdentifier, @RequestBody FamilyRelationInDTO info) throws ElementNotFoundException, InvalidDateException {
