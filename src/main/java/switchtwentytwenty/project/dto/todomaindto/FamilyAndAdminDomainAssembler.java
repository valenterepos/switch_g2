...
public abstract class FamilyAndAdminDomainAssembler {

    /**
     * Map to person dto.
     * @param familyAndAdminDTO - family and admin dto.
     * @return The family and admin required value objects dto.
     */
    public static FamilyAndAdminVODTO toDomain(FamilyAndAdminDTO familyAndAdminDTO) throws InvalidDateException, InvalidEmailException, InvalidVATException, InvalidPersonNameException {
