...
public class PaymentDomainDataAssembler {
    ...
    public PaymentJPA toData(Transaction payment, LedgerJPA ledgerJPA) {
        ...
        return new PaymentJPA.PaymentJPABuilder()
     ...
     *
     * @param paymentJPA - JPA instance
     * @return - Domain instance
     * @throws ParseException               - read
     * @throws InvalidMovementTypeException - illegal movement type - internal erros
     */
    public Transaction toDomain(PaymentJPA paymentJPA) throws ParseException, InvalidMovementTypeException {
