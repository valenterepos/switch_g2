...
public class TransferDomainDataAssembler {
    ...
    /**
     * Domain instance to JPA instance.
     *
     * @param transfer  - domain instance
     * @param ledgerJPA - ledger JPA as foreign key
     * @return JPA instance
     */
    public TransferJPA toData(Transaction transfer, LedgerJPA ledgerJPA) {
        ...
        return new TransferJPA.TransferJPABuilder()
    ...
    /**
     * JPA instance to Domain instance.
     *
     * @param transferJPA - JPA instance
     * @return - Domain instance
     * @throws ParseException               - read
     * @throws InvalidMovementTypeException - illegal movement type - internal erros
     */
    public Transaction toDomain(TransferJPA transferJPA) throws ParseException, InvalidMovementTypeException {
        ...
        TransferAssemblerDTO transferDTO = new TransferAssemblerDTO.TransferAssemblerDTOBuilder()
                .withOriginAccountID(originAccountID)
                .withDestinationAccountID(destinationAccountID)
                .withCategoryID(categoryID)
